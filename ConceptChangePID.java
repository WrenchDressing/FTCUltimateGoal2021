...
@Autonomous(name="ConceptChangePID", group = "")
public class ConceptChangePID extends LinearOpMode {

    // our DC motor.
    DcMotorEx motor_drive_flAsDcMotor;
    ...
    public void runOpMode() {
        ...
        motor_drive_flAsDcMotor = (DcMotorEx)hardwareMap.get(DcMotorEx.class, "motor_drive_flAsDcMotor");
        ...
        PIDFCoefficients pidModified = motor_drive_flAsDcMotor.getPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER);
